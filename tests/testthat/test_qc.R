...
cov_contig <- read_wgs_contig_coverage(system.file("extdata/COLO829.wgs_contig_mean_cov_tumor.csv.gz", package = "dracarys"))
...
test_that("column names are correct", {
  ...
  expect_equal(colnames(ploidy_metrics), c("label", "var", "value"))
